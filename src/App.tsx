...
function App() {
  ...
  // Custom tax groups state (from TaxGroups form)
  const [customTaxGroups, setCustomTaxGroups] = useState<Array<{
    code: string
    name: string
    parentCode: string
  }>>([])
  ...
  // Function to update custom tax groups from TaxGroups form
  const updateCustomTaxGroups = (taxGroups: Array<{ code: string; name: string; parentCode: string }>) => {
    setCustomTaxGroups(taxGroups)
  }
